      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mt-4">
            Modular, open-source components that work together to power the complete Language AI lifecycle. AI4Inclusion's building blocks are already powering real deployments — including AI4I Orchestrate, adopted and rebranded as AI Switch for governed AI access.
          </p>
        </motion.div>
