      ...
      {activeSection === "ai4i-core" && <section className="pt-32 pb-20 px-4" id="ai4i-core">
        <div className="container mx-auto max-w-6xl">
          <motion.div initial={{
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 md:mb-12">An intelligent orchestrator that routes models for domain-aware multilingual inference with policy-based selection, ensembles, scaling, and SLA-driven performance ensuring accurate, efficient, and context-sensitive inferencing across diverse AI workloads.</p>
