          ...
          >
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  a. Cookies are a feature of web browsers that allow web servers to temporarily store information within your browser. Most browsers automatically accept cookies.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  b. This Website uses Google Analytics, a web analytics service provided by Google LLC ("Google"). Google Analytics uses cookies to help analyse how users interact with the Website. The information generated by the cookie about your use of the Website (including your IP address) will be transmitted to and stored by Google on servers which may be located outside India. Google will use this information for the purpose of evaluating your use of the Website, compiling reports on website activity, and providing other services relating to website activity and internet usage. Google may also transfer this information to third parties where required to do so by law, or where such third parties process the information on Google's behalf. By using this Website, you consent to the processing of data about you by Google in the manner and for the purposes set out above. You can opt out of Google Analytics by installing the Google Analytics Opt-out Browser Add-on, available at <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://tools.google.com/dlpage/gaoptout</a>.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  c. Pages that have YouTube videos embedded may enable YouTube to set certain cookies. Read YouTube's Cookie Policy for more details.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  d. Similarly, GitHub uses its own cookies for analytics purposes. You can learn about this in GitHub's Privacy Statement and on the GitHub Subprocessors and Cookies Page.
                </p>
              </div>
