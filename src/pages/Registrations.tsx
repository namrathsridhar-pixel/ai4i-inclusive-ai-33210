      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#0a1628] via-[#0f2847] to-[#1a3a5c] p-8 md:p-10 cursor-pointer hover:border-white/20 transition-all duration-300 shadow-2xl mt-6"
          >
            <div className="absolute inset-0 opacity-[0.03]">
              <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern id="nodes2" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
                    <circle cx="30" cy="30" r="1" fill="white" />
                    <line x1="30" y1="30" x2="60" y2="0" stroke="white" strokeWidth="0.3" />
                    <line x1="30" y1="30" x2="0" y2="60" stroke="white" strokeWidth="0.3" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#nodes2)" />
              </svg>
            </div>
