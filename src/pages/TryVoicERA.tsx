          ...
          <div className="border border-border rounded-2xl bg-card shadow-lg p-8">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h1 className="text-xl font-heading font-bold">VoicERA</h1>
              </div>
              <p className="text-lg font-heading font-semibold mb-1">Talk to VoicERA</p>
            ...
            {status === "success" ? (
              <div className="text-center py-6">
                ...
                <p className="text-sm text-muted-foreground mb-1">You will receive a call shortly from VoicERA.</p>
