        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              AI4Inclusion is powered by a growing global ecosystem of governments, institutions, and organizations committed to inclusive AI innovation. AI4Inclusion's building blocks are already powering real deployments — including AI4I Orchestrate, adopted and rebranded as AI Switch for governed AI access.
            </p>
          </motion.div>
        </div>
      </section>
